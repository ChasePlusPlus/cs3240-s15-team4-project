    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, upload_to='SecureWitness/', default='', null=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            name='Report',
            fields=[
                ('title', models.CharField(max_length=300, default='', primary_key=True, serialize=False)),
