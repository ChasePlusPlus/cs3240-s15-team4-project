...
class User(models.Model):
    ...
    email = models.EmailField(primary_key=True) #Username being the Email address
    pw = models.CharField(max_length=50) #Where we store a hashed version of the password[NOT yet implemented]
